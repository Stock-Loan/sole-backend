...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_pbgc_mid_term_rates_month"), "pbgc_mid_term_rates", ["month"], unique=False
    )
    op.create_index(
        op.f("ix_pbgc_mid_term_rates_year"), "pbgc_mid_term_rates", ["year"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_storage_backend_configs_org_id"),
        "storage_backend_configs",
        ["org_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_org_document_folders_org_id"), "org_document_folders", ["org_id"], unique=False
    )
    op.create_table(
        "org_settings",
        sa.Column("org_id", sa.String(), nullable=False),
        ...
        sa.Column(
            "inactive_user_retention_days", sa.Integer(), server_default="180", nullable=False
        ),
        sa.Column(
            "enforce_service_duration_rule", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column("min_service_duration_years", sa.Numeric(precision=6, scale=2), nullable=True),
        sa.Column(
            "enforce_min_vested_to_exercise", sa.Boolean(), server_default="false", nullable=False
        ),
        ...
        sa.Column(
            "variable_base_rate_annual_percent", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column(
            "variable_margin_annual_percent", sa.Numeric(precision=10, scale=4), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "org_id", "user_id", "resource_type", "resource_id", name="uq_acl_org_user_resource"
        ),
    )
    op.create_index(
        op.f("ix_access_control_list_org_id"), "access_control_list", ["org_id"], unique=False
    )
    op.create_index(
        op.f("ix_access_control_list_user_id"), "access_control_list", ["user_id"], unique=False
    )
    op.create_table(
        "announcement_reads",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_org_document_templates_folder_id"),
        "org_document_templates",
        ["folder_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_org_document_templates_org_id"), "org_document_templates", ["org_id"], unique=False
    )
    op.create_table(
        "org_memberships",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_mfa_devices_org_id"), "user_mfa_devices", ["org_id"], unique=False
    )
    op.create_index(
        op.f("ix_user_mfa_devices_token_hash"), "user_mfa_devices", ["token_hash"], unique=True
    )
    op.create_index(
        op.f("ix_user_mfa_devices_user_id"), "user_mfa_devices", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_user_mfa_recovery_codes_org_id"),
        "user_mfa_recovery_codes",
        ["org_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_permissions_org_id"), "user_permissions", ["org_id"], unique=False
    )
    op.create_index(
        op.f("ix_user_permissions_user_id"), "user_permissions", ["user_id"], unique=False
    )
    op.create_table(
        "user_roles",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "exercise_price >= 0", name="ck_stock_grants_exercise_price_nonnegative"
        ),
    ...
    op.create_index(
        op.f("ix_employee_stock_grants_org_id"), "employee_stock_grants", ["org_id"], unique=False
    )
    op.create_index(
        op.f("ix_employee_stock_grants_org_membership_id"),
        "employee_stock_grants",
        ["org_membership_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "eligibility_result_snapshot", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        ...
        sa.CheckConstraint(
            "allocation_strategy IN ('OLDEST_VESTED_FIRST')", name="ck_loan_app_allocation_strategy"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "selection_value_snapshot >= 0", name="ck_loan_app_selection_value_nonneg"
        ),
    ...
    op.create_index(
        op.f("ix_loan_applications_org_id"), "loan_applications", ["org_id"], unique=False
    )
    op.create_index(
        op.f("ix_loan_applications_org_membership_id"),
        "loan_applications",
        ["org_membership_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_org_user_profiles_membership_id"),
        "org_user_profiles",
        ["membership_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_org_user_profiles_org_id"), "org_user_profiles", ["org_id"], unique=False
    )
    op.create_table(
        "loan_documents",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_loan_documents_loan_application_id"),
        "loan_documents",
        ["loan_application_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_loan_documents_org_stage_type", "loan_documents", ["org_id", "stage_type"], unique=False
    )
    op.create_table(
        "loan_repayments",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_loan_repayments_loan_application_id"),
        "loan_repayments",
        ["loan_application_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_loan_repayments_org_loan",
        "loan_repayments",
        ["org_id", "loan_application_id"],
        unique=False,
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_loan_workflow_stages_loan_application_id"),
        "loan_workflow_stages",
        ["loan_application_id"],
        unique=False,
    )
    op.create_index(
        "ix_loan_workflow_stages_org_id", "loan_workflow_stages", ["org_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_stock_grant_reservations_grant_id"),
        "stock_grant_reservations",
        ["grant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_stock_grant_reservations_loan_application_id"),
        "stock_grant_reservations",
        ["loan_application_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_stock_grant_reservations_org_id"),
        "stock_grant_reservations",
        ["org_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_stock_grant_reservations_org_membership_id"),
        "stock_grant_reservations",
        ["org_membership_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_vesting_events_grant_id"), "vesting_events", ["grant_id"], unique=False
    )
    op.create_index(op.f("ix_vesting_events_org_id"), "vesting_events", ["org_id"], unique=False)
    op.create_index(
        op.f("ix_vesting_events_vest_date"), "vesting_events", ["vest_date"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_stock_grant_reservations_org_membership_id"), table_name="stock_grant_reservations"
    )
    op.drop_index(op.f("ix_stock_grant_reservations_org_id"), table_name="stock_grant_reservations")
    op.drop_index(
        op.f("ix_stock_grant_reservations_loan_application_id"),
        table_name="stock_grant_reservations",
    )
    op.drop_index(
        op.f("ix_stock_grant_reservations_grant_id"), table_name="stock_grant_reservations"
    )
    ...
    op.drop_index(
        op.f("ix_loan_workflow_stages_loan_application_id"), table_name="loan_workflow_stages"
    )
    ...
    op.drop_index(
        op.f("ix_employee_stock_grants_org_membership_id"), table_name="employee_stock_grants"
    )
